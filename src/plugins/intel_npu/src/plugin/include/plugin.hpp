...
private:
    void init_options();
    void recheck_compiler_support(PluginConfig& cfg) const;
    PluginConfig fork_local_config(const std::map<std::string, std::string>& rawConfig,
